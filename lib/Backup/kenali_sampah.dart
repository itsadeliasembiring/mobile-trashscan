                ...
                children: [
                  if (_image == null) ...[
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            ...
                            shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(12),
                              side: BorderSide(color: Color(0xFF3D7F5F), width: 1),
                            ),
                          ),
                          child: Text(
                            "Input Manual",
                    ...
                    TextButton.icon(
                      ...
                      icon: Icon(Icons.photo_library, color: Color(0xFF3D7F5F)),
                      label: Text(
                        "Pilih dari Galeri",
                        style: GoogleFonts.poppins(
                          fontSize: 14,
                        ...
                        children: [
                          ...
                          OutlinedButton(
                            ...
                            style: OutlinedButton.styleFrom(
                              side: BorderSide(color: Color(0xFF3D7F5F)),
                              padding: EdgeInsets.symmetric(horizontal: 24, vertical: 14),
                              shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(12),
                              ),
